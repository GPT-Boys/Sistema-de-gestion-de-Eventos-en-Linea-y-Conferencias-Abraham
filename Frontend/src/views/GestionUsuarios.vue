  ...
  <div class="gestion-usuarios-vista">
    ...
    <div class="area-contenido">
      ...
      <div class="panel-acciones">
        <button class="boton-panel modificar">MODIFICAR</button>
        <button class="boton-panel eliminar">ELIMINAR</button>
        <button class="boton-panel bloquear">BLOQUEAR</button>
      </div>
    </div>
  </div>
</template>
...
.panel-lista-usuarios { flex-grow: 1; min-height: 500px; } /* Quitamos el fondo gris de aquí */
...
.panel-acciones { display: flex; flex-direction: column; gap: 1rem; }
.boton-panel { padding: 1rem 1.5rem; border: none; border-radius: 5px; color: white; font-weight: bold; cursor: pointer; }
.modificar { background-color: #28a745; }
.eliminar { background-color: #dc3545; }
.bloquear { background-color: #ffc107; color: #333;}
</style>