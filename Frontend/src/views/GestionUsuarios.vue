...
function sort(col) {
  if (us.sortBy === col) {
    us.sortDir = us.sortDir === 'asc' ? 'desc' : 'asc'
  } else {
    us.sortBy = col
    us.sortDir = 'asc'
  }
  ...
  <div class="users">
      ...
      <div class="table-wrap">
        <table class="table">
          ...
          <tbody v-if="!us.loading && us.items.length">
            <tr v-for="u in us.items" :key="u.id">
              ...
              <td class="actions-cell">
                <button class="icon" @click="openEdit(u)" title="Editar">
                  <i class="bi bi-pencil-square"></i>
                </button>
                <button class="icon danger" @click="confirmDel = u" title="Eliminar">
          ...
          <tbody v-else-if="us.loading">
            <tr>
              <td colspan="7"><div class="skeleton h40"></div></td>
            </tr>
            <tr>
              <td colspan="7"><div class="skeleton h40"></div></td>
            </tr>
    ...
    <div v-if="showModal" class="backdrop" @click.self="showModal = false">
      <div class="modal">
        ...
        <div class="grid">
          ...
          <label
            >Contraseña <input v-model="form.contrasenia" type="password" placeholder="••••••••"
          /></label>
    ...
    <div v-if="confirmDel" class="backdrop" @click.self="confirmDel = null">
      <div class="modal">
        ...
        <p>
          ¿Eliminar <strong>{{ confirmDel.usuario }}</strong
