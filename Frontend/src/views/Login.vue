...
.head h1{ margin: 0 0 4px; font-size: 26px; font-weight: 800; color:#111827; text-align:center; }
.sub{ margin: 0 0 12px; color:#6b7280; text-align:center; }

.label{ display:block; font-size:13px; color:#374151; margin:10px 0 6px; }
.check{ display:flex; align-items:center; gap:10px; margin:8px 0 12px; color:#374151; font-size:14px; }
.check input{ width:16px; height:16px; }

.control{ position:relative; margin-bottom:8px; }
.control input{
  width:100%; padding:12px 42px; border-radius:14px; border:1px solid #e5e7eb; background:#fff; font-size:14px;
  outline:none; transition: box-shadow .15s ease, border-color .15s ease;
}
.control input:focus{ border-color: var(--purple-600); box-shadow: var(--ring); }
.icon{ position:absolute; top:50%; transform:translateY(-50%); width:22px; height:22px; display:grid; place-items:center; opacity:.8; }
...
.aes-btn:hover{ transform: translateY(-2px); filter: brightness(1.05); }
.aes-btn:disabled{ opacity:.7; cursor:default; }
.aes-btn:focus-visible{ outline:none; box-shadow: var(--ring); }

.foot-links{ margin-top:10px; text-align:center; }
.foot-links .a{ color: var(--purple-700); font-weight:600; text-decoration:none; }
.foot-links .a:hover{ text-decoration:underline; }

.notice{ border-radius:12px; padding:11px 14px; font-size:14px; margin:6px 0 10px;
...
@media (max-height: 760px){
  ...
  .control input{ padding: 10px 38px; }
