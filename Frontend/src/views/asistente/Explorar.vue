...
// Fuente de datos
const baseList = computed(() => tab.value === 'finalizadas'
  ? store.finishedList
  : store.activeList)
...
function setTab(t) { tab.value = t; localStorage.setItem('exp-tab', t) }
</script>
  ...
  <div class="container py-4">
    ...
    <div class="mb-4">
      <h1 class="h3 fw-bold text-primary">
        <i class="bi bi-search"></i> Explorar charlas
      </h1>
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <!-- Tabs -->
        <div class="btn-group">
          <button class="btn" :class="tab==='activas' ? 'btn-primary' : 'btn-outline-primary'" @click="setTab('activas')">
            Activas
          </button>
          <button class="btn" :class="tab==='finalizadas' ? 'btn-primary' : 'btn-outline-primary'" @click="setTab('finalizadas')">
            Finalizadas
          </button>
        </div>
        ...
        <div class="card h-100 shadow-sm border-0">
          <div class="card-body d-flex flex-column">
            ...
            <div v-if="store.statusOf(c)!=='finished'" class="d-flex flex-wrap gap-2 mt-auto">
              ...
              <a v-if="canJoinZoom(c)" :href="c.zoomUrl" target="_blank" class="btn btn-primary btn-sm flex-fill">
