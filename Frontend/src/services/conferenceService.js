...
export const createConference = (payload) =>
  api.post('/conferencias', payload);

// Mis conferencias (orador)
export const getMyConferences = () =>
  api.get('/conferencias/mias');

// Todas las conferencias (asistente)
export const getAllConferences = (params = {}) =>
  api.get('/conferencias', { params });
